...
public class AsteroidField extends BodyExtreme {
    

    public AsteroidField(double radius) {
        super();
    ...
    public static AsteroidField[] field(int n, double radius){
        AsteroidField[] arrAst = new AsteroidField[n];
        for(int i = 0; i < n; i++){
            arrAst[i] = new AsteroidField(radius);
        }
        return arrAst;
    }
